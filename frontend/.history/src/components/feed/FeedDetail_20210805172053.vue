    ...
    <div class="feed-detail-bottom margin-sm">
      ...
      <div class="i-am-like">
        ...
        <div class="align-items-center">
          <p class="align-items-center" v-if="isLike">
            {{ feedItem.likeCnt }} 명이 좋아합니다.
          </p>
          <p class="align-items-center" v-else-if="feedItem.likeCnt - 1 > 0">
            {{ feedItem.userID }}님 외에 {{ feedItem.likeCnt - 1 }} 명이
            좋아합니다.
          </p>
          <p class="align-items-center" v-else>
            {{ feedItem.userID }}님이 좋아합니다.
          </p>
        </div>
      </div>
