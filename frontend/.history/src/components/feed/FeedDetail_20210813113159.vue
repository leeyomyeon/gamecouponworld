<template>
  <div>
    ...
    <!-- 사진이 나타나는 곳 -->
    <div class="photo-zone d-flex">
      <button @click="moveSlideToLeft" style="width: 10%">&#60;</button>
      <img :src="photos[photoNum]" style="width: 90%" />
      <button @click="moveSlideToRight" style="width: 10%">&#62;</button>
    </div>
    <!-- 하단부 -->
