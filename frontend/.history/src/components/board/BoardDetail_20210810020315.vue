<template>
  <div>
    ...
    <div class="btn-list">
      <button class="btn-primary btn-list" @click="$router.push('/board')">
        목록
      </button>
      <div v-if="userID == `${detail.writer}`">
        <button class="btn-primary btn-list" @click="deleteBoardData">
          삭제하기
        </button>
        <button class="btn-primary btn-list" @click="move">수정하기</button>
      </div>
    </div>
  </div>
</template>
